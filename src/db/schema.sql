...
CREATE TABLE Events (
    ...
    created_by INTEGER DEFAULT '—',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP,
    attachment_url VARCHAR(500),
    id INTEGER,
    event_id INTEGER DEFAULT '—',
...
CREATE TABLE FinancialData (
    id UUID NOT NULL,
    soceity_id UUID,
    current_maINTainance_collected DOUBLE NOT NULL DEFAULT 0,
    current_maINTainance_pending DOUBLE NOT NULL DEFAULT 0,
    cash_reserve DOUBLE NOT NULL DEFAULT 0,
...
CREATE TABLE MaintainceConfigs (
    ...
    amount_per_sqft DOUBLE DEFAULT 0,
    late_fee DOUBLE DEFAULT 0,
    late_fee_grace_days DOUBLE DEFAULT 0,
...
CREATE TABLE OneTimeCollection (
    ...
    total_target_amount DOUBLE NOT NULL DEFAULT 0,
    per_flat_amount DOUBLE NOT NULL DEFAULT 0,
    calculation_method INTEGER NOT NULL,
    due_date INTEGER NOT NULL,
    late_fee DOUBLE,
    late_fee_grace_days DOUBLE,
    status INTEGER NOT NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    created_by UUID NOT NULL,
    PRIMARY KEY (id)
